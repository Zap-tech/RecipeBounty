...
contract EternalDb is DSAuth {
  ...
  function getUIntValues(bytes32[] records) public constant returns (uint[] results){
  ...
  function getBytes32Values(bytes32[] records) public constant returns (bytes32[] results){
  ...
  function getBooleanValues(bytes32[] records) public constant returns (bool[] results){
  ...
  function getIntValues(bytes32[] records) public constant returns (int[] results){
